...
function reloadAllowlist() {
  // perform a guarded read+parse so callers get a clear boolean and we don't
  // rely on loadAllowlist's internal try/catch handling.
  try {
    const raw = require('fs').readFileSync(allowlistPath, 'utf8');
